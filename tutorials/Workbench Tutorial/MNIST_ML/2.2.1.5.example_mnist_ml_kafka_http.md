# MNIST를 이용한 머신러닝 모델 예제 (kafka방식으로 입력받아 HTTP 통신을 통해 데이터 전달하기) 
...
IN2WISER  웹툴킷 상단 <b>Monitoring</b> 에서 <b>Workflow</b> 탭을 선택하여, 현재 Status가 Inprogress인 01-05.MNIST_kafka_http(csle1:9092, in2wiserex:53105) 워크플로우의 정지버튼(<span style="color:red">&#9724;</span>)을 클릭하여 종료시킵니다.
