...
서비스를 운용하기 위하여 (주)인투와이즈 관리자가 제공한 model, pymodule, dataset의 저장소입니다. HDFS에 업로드 된 model, pymodule, dataset 등의 파일이 회손되었을 경우 Swift Repository에 저장된 파일을 다운로드하여 복원할 수 있습니다. 사용자는 Swift Repository에 업로드 된 파일을 임의로 삭제할 수 없습니다.
