...
1. HDFS에 이동하고자 하는 Swift Repository의 파일/폴더를 선택합니다.  (동일한 Swift Repository 폴더 내에서는 다중 선택이 가능합니다.)
2. HDFS에서 파일을 저장하고자 하는 경로를 선택합니다.
3.  **>** 버튼을 이용하여 선택한 HDFS 경로에 Swift Repository에서 선택된 파일/폴더가 이동합니다. 
